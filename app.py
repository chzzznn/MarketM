...
from src.market_maker import sentiment_adaptive_strategy
from src.portfolio import Portfolio
from src.dice import roll_dice_pool, roll_volatility_die, roll_direction 
...
def simulate_round():
    ...
    for asset in st.session_state.assets:
        mm_orders = sentiment_adaptive_strategy(asset, sentiment)  # fixed: same sentiment
